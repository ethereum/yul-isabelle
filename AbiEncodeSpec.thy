...
| Etuple_dyn : "\<And> ts vs t heads head_types tails start full_code . 
      ...
      (\<And> offset v . (offset, v) \<in>  tails \<Longrightarrow> can_encode v offset full_code) \<Longrightarrow>
