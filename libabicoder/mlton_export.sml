...
val e = _export "abicoder_encode": (char vector*char vector -> char vector) -> unit;
val _ = e (fn (x,y) => Vector.fromList (explode (ABICoder.encode (implode (toList x)) (implode (toList y)))));
